...
package com.graphaware.module.lifecycle.programmatic;

import com.graphaware.common.util.IterableUtils;
import com.graphaware.module.lifecycle.LifecycleConfiguration;
import com.graphaware.module.lifecycle.LifecyleModule;
import com.graphaware.module.lifecycle.event.ExpiryEvent;
import com.graphaware.module.lifecycle.event.NodeExpiryEvent;
import com.graphaware.module.lifecycle.event.RelationshipExpiryEvent;
import com.graphaware.module.lifecycle.event.strategy.DeleteNodeAndRelationships;
import com.graphaware.module.lifecycle.event.strategy.DeleteOrphanedNodeOnly;
...
import static com.graphaware.module.lifecycle.LifecycleConfiguration.defaultConfiguration;
import static com.graphaware.module.lifecycle.event.NodeExpiryEvent.*;
import static com.graphaware.module.lifecycle.event.NodeExpiryEvent.NODE_EXPIRATION_PROPERTY;
import static com.graphaware.module.lifecycle.event.NodeExpiryEvent.NODE_TTL_PROPERTY;
import static com.graphaware.module.lifecycle.event.RelationshipExpiryEvent.RELATIONSHIP_EXPIRATION_INDEX;
import static com.graphaware.module.lifecycle.event.RelationshipExpiryEvent.RELATIONSHIP_EXPIRATION_PROPERTY;
import static com.graphaware.module.lifecycle.event.RelationshipExpiryEvent.RELATIONSHIP_TTL_PROPERTY;
...
public class ProgrammaticIntegrationTest extends EmbeddedDatabaseIntegrationTest {
	...
	public void shouldExpireNodesWhenExpiryDateReached() {
		bootstrap(defaultConfiguration()
	...
	public void shouldBeAbleToApplyAnOffsetToExpiryDates() {
		bootstrap(defaultConfiguration()
				...
				.withConfig(ExpiryEvent.EXPIRY_OFFSET, "10000")
				.scanForEvents());
